...
class AutomateBase :
    ...
    def __init__ (self, listTransitions, listStates=None, label=None) :
        ...
        self.listTransitions = copy.copy(listTransitions)
        self.listStates = copy.copy(self.getListStates())
    ...
    def removeState(self, state) :
        ...
        if state in self.listStates :
                lt= copy.copy(self.listTransitions)
                for t in lt :
    ...
    def show (self, nomFichier) :
        ...
        try :
            ...
            #LINUX
            os.system("acroread " + nomFichier + ".pdf &")
